...
import sb223ce.*; // Replace with a package (named after your LNU user name, e.g. na222fx) that contains your implementation of the DirectedGraph and GML interface/abstract class*;
